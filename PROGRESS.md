...
| 41 | **implemented; full validation in progress** |
| 42–60 | open |
...
**Active issue:** #41 — re-key learner-owned records during learner-key deduplication (implemented; full validation in progress).
**Next concrete step:**
1. Complete full validation and commit #41 as an isolated fix.
2. Continue with #42 and validate it before moving to #43.
