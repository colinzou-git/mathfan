...
| src/features/diagnosis/diagnosticAnswerProposal.ts | ../../types/math |
| src/features/diagnosis/diagnosticAnswerProposal.ts | ../learning/learningEvents |
| src/features/diagnosis/diagnosticAnswerProposal.ts | ../learning/schedulingTelemetry |
| src/features/diagnosis/diagnosticAnswerProposal.ts | ../mastery/misconceptionEngine |
| src/features/diagnosis/diagnosticAnswerProposal.ts | ../practice/answerChecker |
| src/features/diagnosis/diagnosticAnswerProposal.ts | ../scheduler/cardModel |
| src/features/diagnosis/diagnosticAnswerProposal.ts | ../scheduler/scheduler |
| src/features/diagnosis/diagnosticAnswerProposal.ts | ./diagnosticPersistence |
| src/features/diagnosis/diagnosticCompletion.ts | ../sync/driveSync |
| src/features/diagnosis/diagnosticPersistence.ts | ../../db/dexie |
| src/features/diagnosis/diagnosticPersistence.ts | ../../types/math |
| src/features/diagnosis/diagnosticPersistence.ts | ../learning/learningEvents |
...
| src/features/diagnosis/DiagnosticSession.tsx | ./diagnosticAnswerProposal |
...
| src/features/goals/goalEvaluationPersistence.ts | ../learning/schedulingTelemetry |
| src/features/goals/goalEvaluationPersistence.ts | ../mastery/misconceptionEngine |
| src/features/goals/goalEvaluationPersistence.ts | ../practice/answerChecker |
| src/features/goals/goalEvaluationPersistence.ts | ../scheduler/cardModel |
| src/features/goals/goalEvaluationPersistence.ts | ../scheduler/scheduler |
...
| src/tests/diagnosticPersistence.test.ts | ../db/dexie |
| src/tests/diagnosticPersistence.test.ts | ../features/curriculum/makeItemFromId |
| src/tests/diagnosticPersistence.test.ts | ../features/diagnosis/diagnosticAnswerProposal |
| src/tests/diagnosticPersistence.test.ts | ../features/diagnosis/diagnosticPersistence |
| src/tests/diagnosticPersistence.test.ts | ../features/learning/eventRebuild |
...
| src/tests/diagnosticSession.test.tsx | ../types/math |
...
| src/tests/goalEvaluationConcurrency.test.ts | ../features/curriculum/makeItemFromId |
...
| src/tests/goalEvaluationConcurrency.test.ts | ../features/learning/eventRebuild |
| src/tests/goalEvaluationConcurrency.test.ts | ../features/scheduler/scheduler |
